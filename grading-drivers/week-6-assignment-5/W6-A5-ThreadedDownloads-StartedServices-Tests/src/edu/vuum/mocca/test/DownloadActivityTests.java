 ...
 * 
 * @brief Tests the functionality of DownloadActivity. Current tests only press
 *        buttons and check that the correct image was downloaded.
 */
public class DownloadActivityTests extends
	...
	public void testIntentServiceButton() throws Exception {
		...
		mSolo.clickOnView(mSolo
				.getView(edu.vuum.mocca.R.id.intent_service_button));
